...
class HeteData():
    def __init__(self, data_root="data", dataset="DBLP", train_percent=None, shuffle=False):
        ...
        pdir = os.path.abspath(os.path.join(current_file_path, os.pardir))
        ppdir = os.path.abspath(os.path.join(pdir, os.pardir))
        datadir = os.path.join(ppdir, data_root)

        self.dataset = dataset
        self.path = os.path.join(datadir, dataset)
        self.type_num = 3
